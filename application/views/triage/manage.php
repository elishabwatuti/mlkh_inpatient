...
<div id="search_filter_section" style="background-color:#EEEEEE;">
	...
	<?php echo form_label('Accident and Emergency:', 'accident_queue');?>
	<?php echo form_radio(array('name'=>'admission_queue','id'=>'accident_queue','value'=>'Accident and Emergency','checked'=> isset($admission_queue)?  ( ($admission_queue == 'Accident and Emergency')? 1 : 0) : 0)).' | ';?>
	...
	<div style="margin-top:5px;text-align:center;">
		<?php echo anchor("triage/new_customer/width:350",
		"<div class='small_button' style='margin:0 auto;'><span>New A&E Patient</span></div>",
