...
else
{
	...
	?>
		...
		<td>
		<?php
        	if($item['is_serialized']==1 || $item['invoice'])
        	{
        		echo $item['quantity'];
...
<div id="overall_sale">
	...
	else
	{
		...
		<?php echo anchor("sales/new_customer/width:350",
	...
	<div id="Payment_Types" >
		...
		<div style="height:100px;">
			...
			<!--<tr>
			<td>	
				<?php echo $this->lang->line('sales_attendance').':   ';?>
			</td>
			<td>
...
$(document).ready(function()
{
	...
	$('#section_queue').change(function() 
	{
		$.post('<?php echo site_url("sales/set_section_queue");?>', {section_queue: $('#section_queue').val()});
	});
