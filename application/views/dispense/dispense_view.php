...
<?php $this->load->view("dispense/queue"); ?>
</div>
...
<div id="overall_sale">
	...
	<?php if (isset($customer)): ?>
<table>
	<tr><td><b>Patient Id</b></td><td>:<?php echo $patient_no ?></td></tr>
	<tr><td><b>Name</b></td><td>:<?php echo $customer; ?></td></tr>
	<tr><td><b>Gender</b></td><td>:<?php echo $gender; ?></td></tr>
	<tr><td><b>Age</b></td><td>:<?php echo date_diff(date_create(date("Y-m-d")),date_create(date("Y-m-d",strtotime($age))))->format('%y'); ?></td></tr>
    <tr><td><b>Civil Status</b></td><td>:<?php echo $civil_status; ?></td></tr>
