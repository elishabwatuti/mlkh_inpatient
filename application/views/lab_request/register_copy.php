...
<?php echo form_open("lab_request/add",array('id'=>'add_item_form')); ?>
...
else
{
	foreach(array_reverse($cart, true) as $line=>$item)
	{
		...
		echo form_open("lab_request/edit_item/$line");
	?>
		<tr>
		...
		<td><?php echo anchor("lab_request/delete_item/$line",'['.$this->lang->line('common_delete').']');?></td>
		</tr>
...
<div id="overall_sale">
	...
	if(isset($customer))
	{
		...
		echo anchor("lab_request/remove_customer",'['.$this->lang->line('common_remove').' '.$this->lang->line('customers_customer').']');
	}
	else
	{
		echo form_open("lab_request/select_customer",array('id'=>'select_customer_form')); ?>
	...
	?>
		...
		?>
			<div id="finish_sale">
				<?php echo form_open("lab_request/complete",array('id'=>'finish_invoice_form')); ?>
        ...
        <div id="Cancel_sale">
		<?php echo form_open("lab_request/cancel_invoice",array('id'=>'cancel_sale_form')); ?>
...
{
    $("#item").autocomplete('<?php echo site_url("lab_request/item_search"); ?>',
    {
    	minChars:0,
    	max:100,
    	selectFirst: false,
    ...
    $("#customer").autocomplete('<?php echo site_url("lab_request/customer_search"); ?>',
    {
    	minChars:0,
    	delay:10,
    	max:100,
