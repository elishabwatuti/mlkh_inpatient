...
<div id="overall_sale">
	...
	if(isset($customer))
	{
		...
		echo anchor("xray_report/remove_customer",'['.$this->lang->line('common_remove').' '.$this->lang->line('customers_customer').']');
	}
	else
	{
	...
	?>
		...
		?>
			<div id="finish_sale">
				<?php echo form_open("xray_report/complete",array('id'=>'finish_invoice_form')); ?>
        ...
        <div id="Cancel_sale">
		<?php echo form_open("xray_report/cancel_invoice",array('id'=>'cancel_sale_form')); ?>
