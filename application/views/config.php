...
<div class="field_row clearfix">	
<?php echo form_label($this->lang->line('config_patient_prefix').':', 'patient_prefix',array('class'=>'wide')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'patient_prefix',
		'id'=>'patient_prefix',
		'value'=>$this->config->item('patient_prefix')));?>
	</div>
</div>

<div class="field_row clearfix">	
<?php echo form_label($this->lang->line('config_receipt_prefix').':', 'receipt_prefix',array('class'=>'wide')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'receipt_prefix',
		'id'=>'receipt_prefix',
		'value'=>$this->config->item('receipt_prefix')));?>
	</div>
</div>
