...
<div id="TabbedPanels1" class="TabbedPanels">
  <ul class="TabbedPanelsTabGroup">
    ...
    <!-- Antenatal -->
    <li class="TabbedPanelsTab" tabindex="0">Child Profile</li>
    <li class="TabbedPanelsTab" tabindex="0">Maternal Profile</li>
    <li class="TabbedPanelsTab" tabindex="0">Medical & Surgical History</li>
    <li class="TabbedPanelsTab" tabindex="0">Previous Pregnancy</li>
    <li class="TabbedPanelsTab" tabindex="0">Physical Examination</li>
    <li class="TabbedPanelsTab" tabindex="0">Clinical Notes</li>
    <li class="TabbedPanelsTab" tabindex="0">Current Pregnancy</li>
    <!-- end Antenatal -->
  ...
  <div class="TabbedPanelsContentGroup">
    ...
    <!-- Antenatal -->
    <div class="TabbedPanelsContent"><?php $this->load->view("consultant/antenatal_child_profile"); ?></div>
    <div class="TabbedPanelsContent"><?php $this->load->view("consultant/antenatal_maternal_profile"); ?></div>
    <div class="TabbedPanelsContent"><?php $this->load->view("consultant/antenatal_history"); ?></div>
    <div class="TabbedPanelsContent"><?php $this->load->view("consultant/antenatal_previous_pregnancy"); ?></div>
    <div class="TabbedPanelsContent"><?php $this->load->view("consultant/antenatal_physical_examination"); ?></div>
    <div class="TabbedPanelsContent"><?php $this->load->view("consultant/antenatal_clinical_notes"); ?></div>
    <div class="TabbedPanelsContent"><?php $this->load->view("consultant/antenatal_current_pregnancy"); ?></div>
    <!-- end Antenatal -->
