...
<?php echo form_open($controller_name."/add_xray_item",array('id'=>'add_item_form')); ?>
...
<table>
	...
	<div id='sale_details'>
		...
		if(isset($customer) && count($xray_cart) > 0)
		{
		?>
				<?php echo form_open($controller_name."/complete_xray_request",array('id'=>'finish_invoice_form')); ?>
		...
		?>
                <?php echo form_open($controller_name."/cancel_xray_request",array('id'=>'cancel_sale_form')); ?>
...
{
    $("#item").autocomplete('<?php echo site_url($controller_name."/xray_item_search"); ?>',
    {
    	minChars:0,
    	max:100,
    	selectFirst: false,
