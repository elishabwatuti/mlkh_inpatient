<div id="required_fields_message"><?php
 ...
 echo $this->lang->line('common_fields_required_message'); ?></div>
<ul id="error_message_box"></ul>
<?php
echo form_open($controller_name.'/save/'.$item_info->item_id,array('id'=>'item_form'));
?>
...
<?php
 ...
 echo form_label($this->lang->line('items_unit_price').':', 'unit_price',array('class'=>'required wide')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'unit_price',
		'size'=>'8',
...
<div class="field_row clearfix">	
<?php echo form_label('Drug Drescription:', 'description',array('class'=>'required')); ?>
	<div class='form_field'>
	<?php echo form_dropdown('description',array(
		''=>'',
		'1'=>'AMP/Vial',
		'2'=>'Tablets/Capsules',
		'3'=>'Bottles',
...
<div class="field_row clearfix">	
<?php echo form_label('Drug Classification:', 'classification',array('class'=>'required')); ?>
	<div class='form_field'>
	<?php echo form_dropdown('classification',array(
		''=>'',
		'1'=>'Antibiotic',
		'2'=>'Special',
		'3'=>'General',
		...
		'5'=>'Anti-Retroviral',
		'6'=>'Anti-TB',
		'7'=>'Family Planning Products',
		'8'=>'Vaccine'),
		$item_info->classification);?>
	</div>
</div>

<div class="field_row clearfix">	
<?php echo form_label('Supplier Category:', 'supplier_category',array('class'=>'required')); ?>
	<div class='form_field'>
	<?php echo form_dropdown('supplier_category',array(
		''=>'',
		'1'=>'KEMSA',
		'2'=>'FIF',
		'3'=>'RF',
		'4'=>'Donations'),
		$item_info->supplier_category);?>
	</div>
</div>

<div class="field_row clearfix">	
<?php echo form_label('Route of Administration:', 'route_administration',array('class'=>'required')); ?>
	<div class='form_field'>
	<?php echo form_dropdown('route_administration',array(
		''=>'',
		'1'=>'Oral',
		'2'=>'IV/IM/SC',
		'3'=>'Rectal',
		...
		'6'=>'Vaginal',
		'7'=>'Other'),
		$item_info->route_administration);?>
	</div>
</div>

<div class="field_row clearfix">	
<?php echo form_label('Prescribe Status:', 'prescribe_status',array('class'=>'required')); ?>
	<div class='form_field'>
	<?php echo form_dropdown('prescribe_status',array(
		'1'=>'Available',
		'0'=>'Unavailable'),
		$item_info->prescribe_status);?>
	</div>
</div>

<div class="field_row clearfix">	
<?php echo form_label('Items Under Five:', 'items_under_five',array('class'=>'required')); ?>
	<div class='form_field'>
	<?php echo form_dropdown('items_under_five',array(
		'1'=>'Exempted',
		'0'=>'Not Exempted'),
		$item_info->items_under_five);?>
	</div>
</div>
<!--<div class="field_row clearfix">
...
<div class="field_row clearfix">
<?php echo form_label('Alternate Description:', 'alt_description',array('class'=>'wide')); ?>
	<div class='form_field'>
	<?php echo form_textarea(array(
		'name'=>'alt_description',
		'id'=>'alt_description',
		'value'=>$item_info->allow_alt_description,
		'rows'=>'5',
		'cols'=>'17')
	);?>
	</div>
...
{
	$("#category").autocomplete("<?php echo site_url($controller_name.'/suggest_category');?>",{max:100,minChars:0,delay:10});
	...
	$('#item_form').validate({
		...
		rules:
		{
			...
			prescribe_status:"required",
			items_under_five:"required",
			cost_price:
			{
				required:true,
				number:true
