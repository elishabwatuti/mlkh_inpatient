...
class paedeatrics_consultant extends consultant {

	
	function __construct()
	{
		parent::__construct('paedeatrics_consultant');
		$this->session->set_userdata('clinic','paeds');
		$this->session->set_userdata('consultation','paedeatrics_consultant');
	}
