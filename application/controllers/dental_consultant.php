...
class dental_consultant extends consultant {

	
	function __construct()
	{
		parent::__construct('dental_consultant');
		$this->session->set_userdata('clinic','dental');
		$this->session->set_userdata('consultation','dental_consultant');
	}
