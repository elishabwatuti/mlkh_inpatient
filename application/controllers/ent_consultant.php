...
class ent_consultant extends consultant {

	
	function __construct()
	{
		parent::__construct('ent_consultant');
		$this->session->set_userdata('clinic','ent');
		$this->session->set_userdata('consultation','ent_consultant');
	}
