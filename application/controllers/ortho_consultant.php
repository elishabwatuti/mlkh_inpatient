...
class ortho_consultant extends consultant {

	
	function __construct()
	{
		parent::__construct('ortho_consultant');
		$this->session->set_userdata('clinic','ortho');
		$this->session->set_userdata('consultation','ortho_consultant');
	}
