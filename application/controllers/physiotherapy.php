...
class physiotherapy extends consultant {

	
	function __construct()
	{
		parent::__construct('physiotherapy');
		$this->session->set_userdata('clinic','physio');
		$this->session->set_userdata('consultation','physiotherapy');
	}
