...
class family_plannning_consultant extends consultant {

	
	function __construct()
	{
		parent::__construct('family_planning_consultant');
		$this->session->set_userdata('clinic','fp');
		$this->session->set_userdata('consultation','family_planning_consultant');
	}
