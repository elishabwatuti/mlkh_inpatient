...
class Admissions_View extends Person_controller
{
	function __construct()
	{
		parent::__construct('admissions_view');
	}
	
	function index()
	{
		$config['base_url'] = site_url('/admissions_view/index');
		...
		$data['manage_table']=get_admissions_view_manage_table( $this->Customer->get_all( $config['per_page'], $this->uri->segment( $config['uri_segment'] ) ), $this );
