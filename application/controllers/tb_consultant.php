...
class tb_consultant extends consultant {

	
	function __construct()
	{
		parent::__construct('tb_consultant');
		$this->session->set_userdata('clinic','tb');
		$this->session->set_userdata('consultation','tb_consultant');
	}
