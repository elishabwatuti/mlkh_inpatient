...
class eye_consultant extends consultant {

	
	function __construct()
	{
		parent::__construct('eye_consultant');
		$this->session->set_userdata('clinic','eye');
		$this->session->set_userdata('consultation','eye_consultant');
	}
