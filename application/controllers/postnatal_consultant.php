...
class postnatal_consultant extends consultant {

	
	function __construct()
	{
		parent::__construct('postnatal_consultant');
		$this->session->set_userdata('clinic','pnc');
		$this->session->set_userdata('consultation','postnatal_consultant');
	}
