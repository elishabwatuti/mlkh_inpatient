...
class sti_consultant extends consultant {

	
	function __construct()
	{
		parent::__construct('sti_consultant');
		$this->session->set_userdata('clinic','sti');
		$this->session->set_userdata('consultation','sti_consultant');
	}
